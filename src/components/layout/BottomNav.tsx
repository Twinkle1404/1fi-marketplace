...
export default function BottomNav() {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-around rounded-[var(--radius-pill)] border border-gray-100 bg-[var(--color-bg)] px-2 py-2 shadow-[0_6px_24px_rgba(113,45,220,0.10)]">
        {navItems.map((item) => (
          <NavLink
            key={item.to}
            to={item.to}
